...
if __name__ == "__main__":
    ...
    best_model_name, r2_value = model_trainer.initiate_model_trainer(train_array= train_arr, test_array=test_arr)
    print(f"Best Model: {best_model_name}, R2 Score: {r2_value}")