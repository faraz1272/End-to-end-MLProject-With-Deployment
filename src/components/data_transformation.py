## Here we define the data transformation functions
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        It applies standard scaling to numerical features and one-hot encoding to categorical features.
        Returns:
            preprocessor (ColumnTransformer): A preprocessor object that applies the defined transformations.
        """
        try:
